...
#         set to be empty.
#       - INLINE_SUPPORTED is set to true when inlining is supported and false
#         otherwise.
#
MACRO( CHECK_C_COMPILER_SUPPORTS_INLINE_COMPILE TO_TEST RESULT )
  TRY_COMPILE( ${RESULT}
    ${CMAKE_CURRENT_BINARY_DIR}
    ${CMAKE_CURRENT_SOURCE_DIR}/cmake/CheckCCompilerInline.c
...
#     CONST_SUPPORTED is set to true when const is supported and false otherwise.
#
MACRO( CHECK_C_COMPILER_SUPPORTS_CONST CONST_SUPPORTED )
  ...
  TRY_COMPILE( ${CONST_SUPPORTED}
    ${CMAKE_CURRENT_BINARY_DIR}
    ${CMAKE_CURRENT_SOURCE_DIR}/cmake/CheckCCompilerConst.c
    OUTPUT_VARIABLE DUMMY_OUTPUT_FOR_DEBUG )
